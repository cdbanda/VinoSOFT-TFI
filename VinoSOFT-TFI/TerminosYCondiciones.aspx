<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="TerminosYCondiciones.aspx.cs" Inherits="VinoSOFT_TFI.TerminosYCondiciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="jumbotron">
        <div class="container">
            ...
            <p>Las presentes condiciones de uso de la página web, regulan los términos de acceso y uso de vinosoft.com.ar, propiedad de VinoSOFT S.A. y correo electrónico webmaster@vinosoft.com.ar, en adelante, “la Empresa”, que el usuario del portal deberá aceptar para usar todos los servicios e información que se facilitan desde el portal.</p>
            ...
            <h3>Responsabilidad del Portal sobre los contenidos</h3>
            ...
            <h3>Cumplimiento de Ley de Datos Personales</h3>
            ...
            <p>El usuario manifiesta de forma expresa que cualquier dato personal o de un tercero al que acceda, introduzca, modifique o suprima tiene derecho a hacerlo o dispone de la autorización expresa de este tercero. El portal informa al usuario que podrá ejercer los derechos de acceso, rectificación, oposición y cancelación dirigiéndose a la siguiente dirección: rechazos@vinosoft.com.ar</p>

            <h2>Condiciones de la compraventa</h2>

            <h3>Política de devoluciones</h3>

            <p>Los clientes disponen de un plazo de desistimiento de 15 dias desde la fecha de recepción dentro de los cuales se podrá revocar la compra y la empresa le devolverá el importe abonado. Tras la recepción de la devolución, la empresa se compromete a su reembolso.</p>

            <p>Para realizar de forma efectiva el derecho de desistimiento será necesario: comunicar a la empresa la compra en conjunto con el DNI o CUIT suministrado, y el producto a devolver.</p>

            <h3>Garantía</h3>

            <p>En caso de producto defectuoso, la empresa procederá según corresponda a la reparación, sustitución, rebaja del precio o resolución de la compra, gestiones que serán gratuitas para el consumidor. La empresa responde de las faltas de conformidad que se manifiesten dentro de un plazo de 15 desde la entrega.</p>

            <p>Las condiciones de la garantía son las siguientes: no daño a los productos de la solución, el debe estar en el mismo entorno que fue instalado en el momento de la instalación inicial.</p>

            <h3>Condiciones de pago</h3>

            <p>El cliente declara que tiene plena capacidad para realizar la compra, siendo mayor de edad y estando en posesión de una tarjeta de crédito o débito válida y emitida por un banco que resulte aceptable para la empresa. El Cliente garantiza y se responsabiliza de que todos los datos facilitados sobre su tarjeta sean válidos.</p>
